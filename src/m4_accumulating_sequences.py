...
def run_test_make_less_simple_string():
    ...
    # Test 2 (add your test here):
    expected = '6-7-8'
    actual = make_less_simple_string(6, 8)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def draw_shapes(shapes, window):
    ...
    # TODO 42: add this polymorphism to your notes
    ####################################################################
    # ------------------------------------------------------------------
