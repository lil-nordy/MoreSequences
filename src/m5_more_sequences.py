...
Authors: David Mutchler, Valerie Galluzzi, Mark Hays, Amanda Stouder,
         their colleagues and Nathaniel Neil Nordquist Nate.
...
def index_of_first_negative(numbers):
    ...
    for k in range(len(numbers)):
        if numbers[k] < 0:
            return k
    return -1
# TODO 42: ask why you returned negative one instead of null or something...is it just because you should know that
# index of -3 is impossible?
